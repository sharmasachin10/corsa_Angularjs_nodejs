module.exports = function(app, express) {
     ...
     router.get('/popular', routeObj.randomCars);
     ...
     router.get('/getCarModelType', authorization, routeObj.getCarModelType);
     ...
     router.get('/admin/vehicleList', adminAuthorization, routeObj.admin_vehicleList);
     router.get('/admin/booking', adminAuthorization, routeObj.admin_getVehicleBookingHistory);
