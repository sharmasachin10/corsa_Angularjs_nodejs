...
},{"./controllers/AccountController.js":2,"./controllers/AuthController.js":3,"./controllers/BlogController.js":4,"./controllers/DashboardController.js":5,"./controllers/HomeController.js":6,"./controllers/InfocarController.js":7,"./controllers/ListController.js":8,"./controllers/MessageController.js":9,"./controllers/ModalInstanceController.js":10,"./controllers/ModalPaymentController.js":11,"./controllers/ModalReferralController.js":12,"./controllers/ModelListStatusController.js":13,"./controllers/ModelSendMessage.js":14,"./controllers/NavController.js":15,"./controllers/OrderController.js":16,"./controllers/ReferralController.js":17,"./controllers/SearchController.js":18,"./controllers/SupportController.js":19,"./controllers/TestController.js":20,"./controllers/VehicleController.js":21,"./controllers/VehicleDetailController.js":22,"./controllers/VerificationController.js":23,"./directives/FileUpload.js":24,"./directives/RatingDirective.js":25,"./directives/disableLink.js":26,"./directives/loader.js":27,"./directives/nghtmlCompiler.js":28,"./directives/scrollBottom.js":29,"./filters/FirstChar.js":30,"./filters/StartFrom.js":31,"./interceptors/AuthInterceptor.js":32,"./services/AccountService.js":33,"./services/AuthService.js":34,"./services/BlogService.js":35,"./services/FlashService.js":36,"./services/LocalService.js":37,"./services/RememberMeService.js":38,"./services/SessionService.js":39,"./services/SocketService.js":40,"./services/VehicleService.js":41}],2:[function(require,module,exports){
/**--------------------------------------------------------------------------
Name                   : AccountController
Description            : use to view  the user item & accoununt functionality
--------------------------------------------------------------------------*/

module.exports = function($stateParams,$timeout, $scope,$state, $AuthService, $SessionService, $localStorage,$AccountService, $auth,VehicleService, FlashService, SocketService) {
...
--------------------------------------------------------------------------*/
module.exports =  function ($LocalService,$scope, $rootScope, $state, $stateParams, $AuthService, $RememberService, $localStorage, $auth,$timeout,FlashService, SocketService) {
     ...
     $scope.register = function () {
          $AuthService.register($scope.DataModel, function (response) {
               ...
               if(response.resStatus == "error") {
                    ...
                    $scope.$emit('UpdateSession', {message: response.result});
                    socket.emit('init'  ,  { userId : response.result._id });
                    //$state.go("user.dashboard", {message: serverMsg});
                    $state.go("anon.home", {message: serverMsg});
...
module.exports =  function ($uibModalInstance, $scope, items, VehicleService,$localStorage, $location) {
     ...
     $scope.paypal = function(){
          ...
          if($scope.paymentObj.specifications) {
               //obj.specifications = $scope.paymentObj.specifications;
               obj.model = $scope.paymentObj.specifications.model;
               obj.year = $scope.paymentObj.specifications.year;
          }
          VehicleService.paypal(obj, function(response){
               $scope.isRequestConfirm = true;
               if(response.resStatus == "error") {
                    serverMsg = {resStatus : response.resStatus, msg: response.msg};
                    $scope.serverMsg = serverMsg;
               } else if(response.resStatus == "success") {
                    $scope.isRequestConfirm = false;
                    serverMsg = {resStatus : response.resStatus, msg: response.msg};
...
module.exports =  function($LocalService, $scope, $rootScope, $state, $AuthService, $SessionService, $location, $localStorage) {
     ...
     $scope.logout = function() {
          $AuthService.logout($scope.authUser._id, function (response) {
               if(response == true) {
...
// }
     ...
     $scope.saveInfo = function (obj, activeLInk) {
          ...
          if($scope.modelType) {
               ...
               obj.specifications.vehicleType = $scope.modelType;
          }
     ...
     $scope.updateInfo = function (obj, activeLInk) {
          // console.log(obj.details.features.length);
     //  if(obj.details.features){
     //      for(var i=0; i< obj.details.features.length; i++){
     //           //console.log(obj.details.features[i]);
     //           if(obj.details.features[i] == false){
     //              obj.details.features.splice(i,1)
     //           //$scope.DataModel.details.features[i].checked = true;
     //           }
     //    $scope.DataModel.details.features[i] = $scope.DataModel.details.features[i] || [];
     //    // console.log($scope.DataModel.details.features[i].checked);
     //   }
     // }
          //console.log(obj.details.features);
          if($scope.color) {
     ...
     /** Use to retrive car model Type */
     $scope.getCarModelType  = function (brand, variant) {
          VehicleService.getCarModelType (brand, variant, function (response) {
               serverMsg = {resStatus : response.resStatus, msg: response.msg};
               if(response.resStatus == "error") {
                    $scope.serverMsg = serverMsg;
               } else if(response.resStatus == "success") {
                    $scope.modelType = response.result;
               }
          });
     }
...
/*  image slider */
      $scope.open=function(indx){
        $scope.DataModel.gallery.photos[indx].active=true;
...
module.exports =  function($q,$http, $LocalService, AccessLevels, $localStorage,$SessionService) {
     return {
          ...
          account: function(userId,userObj,cb){
               ...
               formData.append('uId',userObj._id);
...
module.exports = function($http, $LocalService, AccessLevels, $localStorage) {
     return {
          ...
          confirmEmail: function(token,cb) {
               var emailConf = $http.get('/auth/varifyEmail?token='+token);
               emailConf.success(function(response) {
                    cb(response);
               });
          },
...
module.exports =  function($http, $q) {
     return {
          ...
          getCarModelType : function (brand, model, cb) {
               var obj = $http.get('/vehicles/getCarModelType?brand='+brand+"&model="+model);
               obj.then(function(response) {
                    cb(response.data);
               });
          },
          ...
          viewDetailWithFav : function (refId, userId, cb) {
               var obj = $http.get('/vehicles/view?refId='+ refId + "&uId=" + userId);
               obj.then(function(response) {
                    cb(response.data);
               });
          },
