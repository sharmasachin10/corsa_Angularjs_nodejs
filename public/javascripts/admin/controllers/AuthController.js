...
--------------------------------------------------------------------------*/
angular.module('corsaAdminApp').controller('AuthController', ['$LocalService','$scope','$rootScope', '$state', '$stateParams', '$AuthService', '$RememberService', '$localStorage','flashService', function ($LocalService,$scope, $rootScope, $state, $stateParams, $AuthService, $RememberService, $localStorage,flashService) {
